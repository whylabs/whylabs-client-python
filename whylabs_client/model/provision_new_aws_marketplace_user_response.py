...
class ProvisionNewAWSMarketplaceUserResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_id, org_id, model_id, customer_id, *args, **kwargs):  # noqa: E501
        """ProvisionNewAWSMarketplaceUserResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, org_id, model_id, customer_id, *args, **kwargs):  # noqa: E501
        """ProvisionNewAWSMarketplaceUserResponse - a model defined in OpenAPI

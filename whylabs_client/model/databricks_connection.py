...
class DatabricksConnection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, org_id, created_by, connected, workspace_id, access_token, workspace_url, hostname, demo, *args, **kwargs):  # noqa: E501
        """DatabricksConnection - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, org_id, created_by, connected, workspace_id, access_token, workspace_url, hostname, demo, *args, **kwargs):  # noqa: E501
        """DatabricksConnection - a model defined in OpenAPI
